  ...
  return (
    <footer className="bg-white text-gray-800 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={idx}>
                  <Link to={link.to} className="text-gray-600 hover:text-gray-900 transition">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-center space-x-2">
                ...
                <a href="mailto:support@speakwellai.com" className="hover:text-blue-700 transition">
                  support@speakwellai.com
                </a>
              </li>
              <li className="flex items-center space-x-2">
                <Phone className="w-5 h-5 text-green-500" />
                <a href="https://wa.me/91XXXXXXXXXX" className="hover:text-green-700 transition">
                  +91-XXXXXXXXXX
                </a>
              </li>
            </ul>
        ...
        {/* Bottom */}
        <div className="border-t border-gray-200 mt-12 pt-6 text-sm flex flex-col md:flex-row justify-between items-center text-gray-500">
          ...
          <div className="flex items-center space-x-6">
            ...
            <a href="#" className="hover:text-gray-700 transition">Refund Policy</a>
          </div>
        </div>
      </div>
    </footer>
